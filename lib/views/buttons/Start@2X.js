    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <path
          ...
          fill="#000"
        />
        <use fillOpacity={0.801} fill="#FFF" xlinkHref="#start@2x_svg__a" />
        <use
          fill="#000"
          filter="url(#start@2x_svg__b)"
          xlinkHref="#start@2x_svg__a"
        />
      </g>
    </svg>
  );
