    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        <g transform="translate(14.116 22.293)">
          <mask id="exit-active_svg__b" fill="#fff">
            <use xlinkHref="#exit-active_svg__a" />
          </mask>
          <path
