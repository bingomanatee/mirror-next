    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path
          ...
          fill="#000"
        />
        <use fillOpacity={0.801} fill="#FFF" xlinkHref="#exit_svg__a" />
        <use fill="#000" filter="url(#exit_svg__b)" xlinkHref="#exit_svg__a" />
        <g transform="translate(14.116 22.293)">
          <mask id="exit_svg__d" fill="#fff">
            <use xlinkHref="#exit_svg__c" />
          </mask>
          <path
