  ...
  return (
    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        ...
        />
        <use
          filter="url(#exit-hl_svg__a)"
          xlinkHref="#exit-hl_svg__b"
          fill="#000"
        />
        <g transform="translate(14.116 22.293)">
          <mask id="exit-hl_svg__d" fill="#fff">
            <use xlinkHref="#exit-hl_svg__c" />
          </mask>
          <path
