    ...
    >
      ...
      <g fill="none" fillRule="evenodd">
        <path
          ...
          fill="#000"
        />
        <use fillOpacity={0.801} fill="#FFF" xlinkHref="#last@2x_svg__a" />
        <use
          fill="#000"
          filter="url(#last@2x_svg__b)"
          xlinkHref="#last@2x_svg__a"
        />
      </g>
    </svg>
  );
